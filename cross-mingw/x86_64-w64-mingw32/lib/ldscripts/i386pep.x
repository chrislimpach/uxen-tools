...
SEARCH_DIR("=/home/local_slave/local_tools_slave/workspace/DSL_uxentools_build_tools/xen/tools/install/cross-mingw/x86_64-w64-mingw32/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
