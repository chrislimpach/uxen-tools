...
SEARCH_DIR("=/home/local_slave/jenkins/workspace/DSL_uxentools_build_tools/xen/tools/install/cross-vm/x86_64-pe/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
